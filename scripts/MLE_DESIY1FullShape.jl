...
save_dir = home_dir * "/MLE_results_paper/"
...
# Obtains the MLE values for the desired dataset and variation
if dataset == "FS"
    if variation == "LCDM"
...
npzwrite(save_dir * "$(dataset)_$(variation)_MLE_params.npy", MLE_param_estimates)
npzwrite(save_dir * "$(dataset)_$(variation)_MLE_likelihood.npy", MLE_likelihood_estimates)