#!/bin/bash
#SBATCH --job-name=prof_FS++DESY5SN
...
VERSIONS=("ln10As FS+BAO+CMB+DESY5SN LCDM" "ln10As FS+BAO+CMB+DESY5SN w0waCDM" "H0 FS+BAO+CMB+DESY5SN LCDM" "H0 FS+BAO+CMB+DESY5SN w0waCDM" "omegac FS+BAO+CMB+DESY5SN LCDM" "omegac FS+BAO+CMB+DESY5SN w0waCDM" "w0 FS+BAO+CMB+DESY5SN w0waCDM" "wa FS+BAO+CMB+DESY5SN w0waCDM")
RUN_NUMBERS=({1..32})
N_RUNS=100
N_PROFILE=32
