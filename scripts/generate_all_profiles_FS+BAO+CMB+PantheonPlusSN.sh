#!/bin/bash
#SBATCH --job-name=prof_FS++Pantheon
...
VERSIONS=("ln10As FS+BAO+CMB+PantheonPlusSN LCDM" "ln10As FS+BAO+CMB+PantheonPlusSN w0waCDM" "H0 FS+BAO+CMB+PantheonPlusSN LCDM" "H0 FS+BAO+CMB+PantheonPlusSN w0waCDM" "omegac FS+BAO+CMB+PantheonPlusSN LCDM" "omegac FS+BAO+CMB+PantheonPlusSN w0waCDM" "w0 FS+BAO+CMB+PantheonPlusSN w0waCDM" "wa FS+BAO+CMB+PantheonPlusSN w0waCDM")
RUN_NUMBERS=({1..32})
N_RUNS=100
N_PROFILE=32
