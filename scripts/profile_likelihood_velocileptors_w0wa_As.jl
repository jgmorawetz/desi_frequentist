...
@everywhere function run_worker(fixed_value, tracer_vector, nzall, zeffall, pkall, kinall, wmatall, covall, Mono_Emu, Quad_Emu, Hexa_Emu, init_values, N)
    ...
    for i in 1:N # runs N separate runs to avoid convergence issues
       # init_values_guess = init_values + # randomly samples space surrounding initial guess for each trial
        fit_result = maximum_likelihood(fit_model, LBFGS(m=100, P=Diagonal([1/0.01, 1/2, 1/0.0001, 1/0.01, 1/0.1, 1/0.5, 1/0.3, 1/1, 1/1, 1/10, 1/20, 1/1, 1/1, 1/0.3, 1/1, 1/1, 1/10, 1/20, 1/1, 1/1, 1/0.3, 1/1, 1/1, 1/10, 1/20, 1/1, 1/1, 1/0.3, 1/1, 1/1, 1/10, 1/20, 1/1, 1/1, 1/0.3, 1/1, 1/1, 1/10, 1/20, 1/1, 1/1, 1/0.3, 1/1, 1/1, 1/10, 1/20, 1/1, 1/1])))#LBFGS(m=100, P=Diagonal([1/0.01, 1/2, 1/0.0001, 1/0.01, 1/0.3, 1/1, 1/1, 1/10, 1/20, 1/1, 1/1, 1/0.3, 1/1, 1/1, 1/10, 1/20, 1/1, 1/1, 1/0.3, 1/1, 1/1, 1/10, 1/20, 1/1, 1/1, 1/0.3, 1/1, 1/1, 1/10, 1/20, 1/1, 1/1, 1/0.3, 1/1, 1/1, 1/10, 1/20, 1/1, 1/1, 1/0.3, 1/1, 1/1, 1/10, 1/20, 1/1, 1/1])); initial_params=init_values)#_guess)#LBFGS(m=20, P=Diagonal([1/0.03, 1/2, 1/0.00055, 1/0.015, 1/0.7, 1/3, 1/1, 1/50, 1/70, 1/5, 1/1])))#m=100, P=Diagonal([1/0.03, 1/2, 1/0.00055, 1/0.015, 1/0.7, 1/3, 1/1, 1/50, 1/70, 1/5, 1/1,1/0.7, 1/3, 1/1, 1/50, 1/70, 1/5, 1/1,1/0.7, 1/3, 1/1, 1/50, 1/70, 1/5, 1/1,1/0.7, 1/3, 1/1, 1/50, 1/70, 1/5, 1/1,1/0.7, 1/3, 1/1, 1/50, 1/70, 1/5, 1/1,1/0.7, 1/3, 1/1, 1/50, 1/70, 1/5, 1/1])); initial_params=init_values)#1/0.01, 1/0.1, 1/0.0001, 1/0.005, 1/0.05, 1/1, 1/1, 1/2, 1/2, 1/50, 1/500, 1/0.05, 1/1, 1/1, 1/2, 1/2, 1/50, 1/500, 1/0.05, 1/1, 1/1, 1/2, 1/2, 1/50, 1/500]))) # sets rough step sizes corresponding to each dimension of parameter space###############################################################################################################################################
...
@everywhere @model function model(fixed_value, tracer_vector, nzall, zeffall, pkall, kinall, wmatall, covall, Mono_Emu, Quad_Emu, Hexa_Emu)
    ...
    ωc ~ Uniform(0.09, 0.25)
    w0 ~ Uniform(-2, 0.49969)
