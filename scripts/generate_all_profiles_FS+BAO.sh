...
VERSIONS=("ln10As FS+BAO LCDM" "ln10As FS+BAO w0waCDM" "H0 FS+BAO LCDM" "H0 FS+BAO w0waCDM" "omegac FS+BAO LCDM" "omegac FS+BAO w0waCDM" "w0 FS+BAO w0waCDM" "wa FS+BAO w0waCDM")
RUN_NUMBERS=({1..32})
N_RUNS=100
N_PROFILE=32
