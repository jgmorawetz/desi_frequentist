...
VERSIONS=("ln10As FS+BAO+CMB LCDM" "ln10As FS+BAO+CMB w0waCDM" "H0 FS+BAO+CMB LCDM" "H0 FS+BAO+CMB w0waCDM" "omegac FS+BAO+CMB LCDM" "omegac FS+BAO+CMB w0waCDM" "w0 FS+BAO+CMB w0waCDM" "wa FS+BAO+CMB w0waCDM")
RUN_NUMBERS=({1..32})
N_RUNS=100
N_PROFILE=32
