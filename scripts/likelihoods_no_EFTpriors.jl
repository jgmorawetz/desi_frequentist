...
@model function model_FS_freq(D_FS_dict)
...
@model function model_BAO_freq(D_BAO_dict, D_Lya)
...
@model function model_FS_BAO_freq(D_FS_BAO_dict, D_Lya)
...
@model function model_FS_BAO_CMB_freq(D_FS_BAO_dict, D_Lya, D_CMB)
...
@model function model_FS_BAO_CMB_SN_freq(D_FS_BAO_dict, D_Lya, D_CMB, iΓ_SN, D_SN, z_SN, SN_type)
...
@model function model_FS_freq_Omegam(D_FS_dict)
    """Likelihood for full-shape only."""
    # Draws cosmological parameters
    ln10As ~ Uniform(cosmo_ranges_FS_BAO["ln10As"][1], cosmo_ranges_FS_BAO["ln10As"][2])
    ns ~ Truncated(Normal(cosmo_priors["ns"][1], cosmo_priors["ns"][2]), cosmo_ranges_FS_BAO["ns"][1], cosmo_ranges_FS_BAO["ns"][2])               
...
@model function model_BAO_freq_Omegam(D_BAO_dict, D_Lya)
    """Likelihood for BAO only."""
    # Draws cosmological parameters
    ln10As = 3.044 # ln10As and ns not fit for BAO only (set to constant values for emulator)
    ns = 0.9649               
...
@model function model_FS_BAO_freq_Omegam(D_FS_BAO_dict, D_Lya)
    """Likelihood for full-shape and BAO joint."""
    # Draws cosmological parameters
    ln10As ~ Uniform(cosmo_ranges_FS_BAO["ln10As"][1], cosmo_ranges_FS_BAO["ln10As"][2])
    ns ~ Truncated(Normal(cosmo_priors["ns"][1], cosmo_priors["ns"][2]), cosmo_ranges_FS_BAO["ns"][1], cosmo_ranges_FS_BAO["ns"][2])               
...
@model function model_FS_BAO_CMB_freq_Omegam(D_FS_BAO_dict, D_Lya, D_CMB)
    """Likelihood for full-shape, BAO and CMB joint."""
    # Draws cosmological parameters
    ln10As ~ Uniform(cosmo_ranges_CMB["ln10As"][1], cosmo_ranges_CMB["ln10As"][2])
    ns ~ Uniform(cosmo_ranges_CMB["ns"][1], cosmo_ranges_CMB["ns"][2])
...
@model function model_FS_BAO_CMB_SN_freq_Omegam(D_FS_BAO_dict, D_Lya, D_CMB, iΓ_SN, D_SN, z_SN, SN_type)
    """Likelihood for full-shape, BAO, CMB and SN joint."""
    # Draws cosmological parameters
    ln10As ~ Uniform(cosmo_ranges_CMB["ln10As"][1], cosmo_ranges_CMB["ln10As"][2])
    ns ~ Uniform(cosmo_ranges_CMB["ns"][1], cosmo_ranges_CMB["ns"][2])
...
@model function model_FS_freq_sigma8(D_FS_dict)
    """Likelihood for full-shape only."""
    # Draws cosmological parameters
    ...
    w0 ~ Uniform(cosmo_ranges_FS_BAO["w0"][1], cosmo_ranges_FS_BAO["w0"][2])
    wa ~ Uniform(cosmo_ranges_FS_BAO["wa"][1], cosmo_ranges_FS_BAO["wa"][2])
    ln10As = Effort.get_BAO([sigma8, ns, H0, ωb, ωc, w0, wa], sigma8_emu)[1]
    cosmo_params = [ln10As, ns, H0, ωb, ωc, w0, wa]
    # Extracts f and sigma8 values for each tracer using BAO emulator
    fsigma8_info = Effort.get_BAO(cosmo_params, BAO_emu)
    f_dict = Dict("BGS" => fsigma8_info[2], "LRG1" => fsigma8_info[3], "LRG2" => fsigma8_info[4], "LRG3" => fsigma8_info[5], 
...
@model function model_FS_BAO_freq_sigma8(D_FS_BAO_dict, D_Lya)
    """Likelihood for full-shape and BAO joint."""
    # Draws cosmological parameters
    sigma8 ~ Uniform(0.01, 2) # doesn't matter the range used here since fixing based on profile values anyway
    ns ~ Truncated(Normal(cosmo_priors["ns"][1], cosmo_priors["ns"][2]), cosmo_ranges_FS_BAO["ns"][1], cosmo_ranges_FS_BAO["ns"][2])               
...
@model function model_FS_BAO_CMB_freq_sigma8(D_FS_BAO_dict, D_Lya, D_CMB)
    """Likelihood for full-shape, BAO and CMB joint."""
    # Draws cosmological parameters
    sigma8 ~ Uniform(0.01, 2) # doesn't matter the range used here since fixing based on profile values anyway
    ns ~ Uniform(cosmo_ranges_CMB["ns"][1], cosmo_ranges_CMB["ns"][2])
...
@model function model_FS_BAO_CMB_SN_freq_sigma8(D_FS_BAO_dict, D_Lya, D_CMB, iΓ_SN, D_SN, z_SN, SN_type)
    """Likelihood for full-shape, BAO, CMB and SN joint."""
    # Draws cosmological parameters
    sigma8 ~ Uniform(0.01, 2) # doesn't matter the range used here since fixing based on profile values anyway
    ns ~ Uniform(cosmo_ranges_CMB["ns"][1], cosmo_ranges_CMB["ns"][2])
